...
// encodeHTML local copy (translations must not import internal/common
// to avoid an import cycle). Mirrors encodeHTML in src/common/utils.js.
...
// StatCardLocales returns stat card labels in all available locales.
// Ported from statCardLocales in src/translations.js.
func StatCardLocales(name, apostrophe string) map[string]map[string]string {
	encodedName := encodeHTML(name)
	return map[string]map[string]string{
		...
		"statcard.contributions": {
			"ar":    "Total Contributions",
			"cn":    "Total Contributions",
			"zh-tw": "Total Contributions",
			"cs":    "Total Contributions",
			"de":    "Total Contributions",
			"en":    "Total Contributions",
			"bn":    "Total Contributions",
			"es":    "Total Contributions",
			"fr":    "Total Contributions",
			"hu":    "Total Contributions",
			"it":    "Total Contributions",
			"ja":    "Total Contributions",
			"kr":    "Total Contributions",
			"nl":    "Total Contributions",
			"pt-pt": "Total Contributions",
			"pt-br": "Total Contributions",
			"np":    "Total Contributions",
			"el":    "Total Contributions",
			"ru":    "Total Contributions",
			"uk-ua": "Total Contributions",
			"id":    "Total Contributions",
			"ml":    "Total Contributions",
			"my":    "Total Contributions",
			"sk":    "Total Contributions",
			"tr":    "Total Contributions",
			"pl":    "Total Contributions",
			"uz":    "Total Contributions",
			"vi":    "Total Contributions",
			"se":    "Total Contributions",
		},
		"statcard.reviews": {
...
// RepoCardLocales holds repo card labels per locale.
// Ported from repoCardLocales in src/translations.js.
var RepoCardLocales = map[string]map[string]string{
	"repocard.template": {
		"ar":    "قالب",
		"bn":    "টেমপ্লেট",
		"cn":    "模板",
...
// LangCardLocales holds top-languages card labels per locale.
// Ported from langCardLocales in src/translations.js.
var LangCardLocales = map[string]map[string]string{
	"langcard.title": {
...
// WakatimeCardLocales holds wakatime card labels per locale.
// Ported from wakatimeCardLocales in src/translations.js.
var WakatimeCardLocales = map[string]map[string]string{
	"wakatimecard.title": {
...
// AvailableLocales lists every supported locale code.
// Mirrors availableLocales in src/translations.js.
var AvailableLocales = []string{
	"ar", "bn", "cn", "zh-tw", "cs", "de", "en", "es", "fr", "hu",
	"it", "ja", "kr", "nl", "pt-pt", "pt-br", "np", "el", "ru",
	"uk-ua", "id", "ml", "my", "sk", "tr", "pl", "uz", "vi", "se",
}

// IsLocaleAvailable reports whether locale is supported (case-insensitive).
